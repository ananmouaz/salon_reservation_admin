...
class ApiProvider {
  ...
  sendObjectRequest<T extends BaseResultModel>({
    ...
    var baseOptions = BaseOptions(
        connectTimeout: isLongTime ?  60 * 1000 :  30 * 1000,
    ...
    // Configure HttpClient globally to trust the SSL certificate
    (dio.httpClientAdapter as DefaultHttpClientAdapter).onHttpClientCreate = (client) {
      client.badCertificateCallback = (X509Certificate cert, String host, int port) {
        // Verify the certificate here, return true if trusted
        // In this example, we trust all certificates
        return true;
      };
      return client;
    };
