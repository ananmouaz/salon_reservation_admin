...
class AppColors {
  ...
  static Color lightGray = Colors.grey.withOpacity(0.2);
  static const Color lighterGray = Color(0xfff9f9f9);
  static const Color midGray = Color(0xffe4e4e4);
  static const Color midBlue = Color(0xffebebf3);
  static const Color darkGray = Color(0xffaeaeae);
  static const Color darkerGray = Color(0xff8d8d8d);

  static const Color primary = Color(0xffEEB1FF);
  static const Color secondary = Color(0xff733487);
